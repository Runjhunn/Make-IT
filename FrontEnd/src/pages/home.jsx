                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center h-16">
                        ...
                        >
                            ...
                            <span className="text-xl font-display font-bold text-white">Make IT</span>
                        </motion.div>
            ...
            >
                <div className="bg-white/10 backdrop-blur-xl rounded-3xl p-16 border border-white/20 shadow-2xl text-center">
                    ...
                    >
                        ...
                        with Make IT. Start your journey today.
                    </motion.p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                        ...
                        >
                            <div className="flex items-center space-x-2 mb-4">
                                ...
                                <span className="text-2xl font-display font-bold text-white">Make IT</span>
                            </div>
                    ...
                    >
                        <div className="flex flex-col md:flex-row items-center space-y-2 md:space-y-0 md:space-x-6 mb-4 md:mb-0">
                            <p className="text-white/70 text-sm">
                                © 2024 Make IT. All rights reserved.
                            </p>
